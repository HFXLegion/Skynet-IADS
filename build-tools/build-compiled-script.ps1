...
cat ../skynet-iads-source/skynet-iads-supported-types.lua,
 ../skynet-iads-source/highdigitsams/skynet-iads-high-digit-sams-suported-types.lua,
  ../skynet-iads-source/sampack_s300/skynet-iads-sampack-s300-suported-types.lua,
   ../skynet-iads-source/currenthill/skynet-iads-currenthill-russia-suported-types.lua,
    ../skynet-iads-source/currenthill/skynet-iads-currenthill-us-suported-types.lua,
	 ../skynet-iads-source/currenthill/skynet-iads-currenthill-uk-suported-types.lua,
	 ../skynet-iads-source/currenthill/skynet-iads-currenthill-germany-suported-types.lua,
	 ../skynet-iads-source/currenthill/skynet-iads-currenthill-china-suported-types.lua,
				  ...
				  ../skynet-iads-source/skynet-iads-sam-site.lua,
				   ../skynet-iads-source/skynet-iads-sam-tracking-radar.lua,
				    ../skynet-iads-source/syknet-iads-sam-launcher.lua,
					 ../skynet-iads-source/skynet-iads-harm-detection.lua | sc ./tmp/tmp-code.lua 
